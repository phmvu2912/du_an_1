    ...
    <div class="row">
        ...
        <form action="" method="POST" class="row">
            ...
            <div class="col-6 mb-2">
                ...
                <input type="text" class="form-control" id="inputCode" name="code" value="<?= $voucher['ma_khuyen_mai'] ?>">
            </div>

            <!-- Tên đăng nhập -->
            <div class="col-6 mb-2">
                <label for="inputUser" class="form-label font-weight-bold">Nhập giá trị (%):</label>
                <input type="text" class="form-control" id="inputValue" name="value" value="<?= $voucher['gia_tri'] ?>">
            </div>
            
            <!-- Mật khẩu -->
            <div class="col-6 mb-2">
                <label for="inputPass" class="form-label font-weight-bold">Nhập ngày bắt đầu:</label>
                <input type="date" class="form-control" id="inputMGF" name="start" value="<?= $voucher['ngay_bat_dau'] ?>">
            </div>

            <!-- Email -->
            <div class="col-6 mb-2">
                <label for="inputEXP" class="form-label font-weight-bold">Nhập ngày hết hạn:</label>
                <input type="date" class="form-control" id="inputEXP" name="end" value="<?= $voucher['ngay_het_han'] ?>">
            </div>    
